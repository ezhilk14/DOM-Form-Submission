...
var input1 = foo('input', 'text', 'fname', 'fname', 'Enter your Firstname');
...
var input2 = foo('input', 'text', 'lname', 'lname', 'Enter your Lastname');
...
var input3 = foo('input', 'text', 'add1', 'add1', 'Enter your address');
...
var input4 = foo('input', 'text', 'add2', 'add2', 'Enter your City');
...
var input5 = foo('input', 'number', 'pin', 'pin', 'Enter your Pincode');
...
var food = label('label', 'food', 'Choice of Food (choose atleast 2)');
column1.append(food);
...
var input12 = foo('input', 'checkbox', 'food', 'Italian', '');

var tand = label('label', 'tand', '&nbsp; Italian');
...
var input13 = foo('input', 'text', 'state', 'state', 'Enter your state name');
...
var input14 = foo('input', 'text', 'country', 'country', 'Enter your country name');
...
head2.innerHTML = "Provisional Database";
head2.setAttribute('class', 'h3');
